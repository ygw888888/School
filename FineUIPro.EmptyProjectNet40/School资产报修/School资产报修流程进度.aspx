<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="School资产报修流程进度.aspx.cs" Inherits="FineUIPro.EmptyProjectNet40.School资产报修.资产报修流程进度" %>
   ...
   <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <ul class="nav nav-pills nav-justified step step-progress" data-step="4">
                <li>
                    <a>报修人报修<span class="caret"></span></a>
                    <br />
                    <asp:Button ID="s" runat="server" Text="查看详情" />
                </li>

                <li>
                    <a>管理员派单<span class="caret"></span></a>
                    <br />
                </li>
                 <li>
                    <a>维修人员完工<span class="caret"></span></a>
                    <br />
                </li>
                 <li>
                    <a>报修人员确认<span class="caret"></span></a>
                    <br />
                </li>
                <%--<li>
                    <a>管理员创建<span class="caret"></span></a>
                    <br />
                    <asp:Button ID="s" runat="server" Text="查看详情" />
                </li>

                <li>
                    <a>财务人员处理<span class="caret"></span></a>
                    <br />
                </li>--%>
            </ul>
            <style type="text/css">
