<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="设备故障管理.aspx.cs" Inherits="FineUIPro.EmptyProjectNet40.设备故障维修.设备故障管理" %>
...
<%--                                <f:DatePicker runat="server" DateFormatString="yyyy-MM-dd" Label="开始日期" LabelWidth="90" EmptyText="请选择开始日期"
                                ...
                                <f:DropDownList ID="年份" Width="150px" runat="server" Label="年份" LabelWidth="60" AutoPostBack="true" EmptyText="2019" AutoSelectFirstItem="false">
                ...
                <f:Grid ID="GridGZ" IsFluid="true" CssClass="blockpanel" Title="设备故障数据" EnableCollapse="false" PageSize="15" ShowBorder="true" ShowHeader="true"
                    ...
                    DataKeyNames="ID,完成情况,设备编号,设备名称,故障描述,故障时间,解决故障时间,更换备件,问题描述,问题的可能影响,修理费用,报修人,维修人,名称,维修人数,维修工时,维修人员名单,原因分析,开始维修时间,解决方案及计划,解决故障根本问题的办法" OnPageIndexChange="GridGZ_PageIndexChange"  OnRowCommand="Grid1_RowCommand" OnRowDataBound="Grid1_RowDataBound" DataTextField="Name" 
                   >
        ...
        <f:Window ID="Window1" Title="维修信息" Hidden="true" EnableIFrame="false"
