...
{
    public partial class 设备故障管理 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)//是否是客户端回发而加载
            {
                ...
                //GridGZ.DataSource = gzbll.按各单位查询设备故障(0, "", "", "", dt.Year);
                //GridGZ.DataBind();
                BindGrid();
            }
        }
        ...
        protected void Grid1_RowCommand(object sender, GridCommandEventArgs e)
        {
            if (e.CommandName == "Action1")
            {
                ...
                object[] keys = GridGZ.DataKeys[e.RowIndex];
        ...
        protected void SelectContentBtn_Click(object sender, EventArgs e)
        {
            ...
            GridGZ.DataSource = gzbll.按各单位查询设备故障(ID, ttbSearch.Text, year, GridGZ.PageIndex, GridGZ.PageSize);
        ...
        protected void GridGZ_PageIndexChange(object sender, GridPageEventArgs e)
        {
            ...
            GridGZ.RecordCount = gzbll.查询设备故障总数(ID, ttbSearch.Text, year);
            GridGZ.DataSource = gzbll.按各单位查询设备故障(ID, "", year, GridGZ.PageIndex, GridGZ.PageSize-1);
            // 3.绑定到Grid
