<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="数据看板.aspx.cs" Inherits="FineUIPro.EmptyProjectNet40.统计查询.数据看板" %>
...
<html lang="en">
 ...
 <body>
     <br />
     <h1 align="center"><font color="red">数据看板</font></h1>
		...
		<div id="layer02" class="layer" style="height:15%;">
			<div id="layer02_01" style="width:20%;">
				<div class="layer02-data">
					<span style="font-size:26px;">400</span>
			...
			<div id="layer02_02" style="width:20%;">
				<div class="layer02-data">
					<span style="font-size:26px;">300</span>
			...
			<div id="layer02_03" style="width:21%;">
				<div class="layer02-data">
					<span style="font-size:26px;">5167</span>
