            ...
            <Items>
                ...
                <f:Grid ID="Grid1" Title="数据表格" PageSize="15" IsFluid="true" CssClass="blockpanel" ShowBorder="true" BoxFlex="1" AllowPaging="true" IsDatabasePaging="false"
                    ...
                    <Columns>
                        ...
                        <f:RenderField ColumnID="记账人" DataField="记账人" HeaderText="记账人"  Hidden="true"/>
                        <f:RenderField ColumnID="总数" DataField="总数" HeaderText="总数" Hidden="true"/>
                        <f:RenderField ColumnID="总价" DataField="总价" HeaderText="变动金额合计" />
                        <f:RenderField ColumnID="变动方式" DataField="变动方式" HeaderText="变动方式" />
                        <f:RenderField ColumnID="变动原因" DataField="变动原因" HeaderText="变动原因" ExpandUnusedSpace="true"></f:RenderField>
                        <f:RenderField ColumnID="记账人意见" DataField="记账人意见" HeaderText="记账人意见" Hidden="true"></f:RenderField>
                        <f:RenderField ColumnID="备注信息" DataField="备注信息" HeaderText="备注信息" Hidden="true"></f:RenderField>
                ...
                <f:Panel ID="Panel2" IsFluid="true" CssClass="blockpanel" runat="server" ShowBorder="false" Layout="VBox" BodyPadding="10px" ShowHeader="false">
                    <Items>
                        <f:ContentPanel runat="server" Title="asd" ShowHeader="False">
                            ...
                            <f:TextBox runat="server" Label="记账人" ID="记账人" Width="300px" LabelWidth="120" Readonly="true"></f:TextBox>
                            ...
                            <f:Grid ID="Grid2" ShowBorder="true" BoxFlex="1" ShowHeader="true" Title="原值变动"
                                ...
                                <Columns>
                                    ...
                                    <f:RenderField ColumnID="存放地点" DataField="房间名称" HeaderText="存放地点" />
                                    <f:RenderField ColumnID="部门名称" DataField="部门名称" HeaderText="部门名称" />
                                    <f:RenderField ColumnID="负责人" DataField="负责人" HeaderText="负责人" />
                                    <f:RenderField ColumnID="变动前原值" DataField="价格" HeaderText="变动前原值" />
                                    <f:RenderField Width="100px" ColumnID="变动金额" DataField="变动金额" FieldType="Int" HeaderText="变动金额">
                                        <Editor>
                                            <f:NumberBox ID="moneynum" NoDecimal="true" AutoPostBack="true" NoNegative="true" runat="server">
                                            </f:NumberBox>
                                        </Editor>
                                    </f:RenderField>
                                    <f:RenderField ColumnID="变动后原值" DataField="变动后原值" HeaderText="变动后原值" />
