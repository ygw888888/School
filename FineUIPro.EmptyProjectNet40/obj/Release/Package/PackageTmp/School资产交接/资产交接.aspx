<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="资产交接.aspx.cs" Inherits="FineUIPro.EmptyProjectNet40.School资产交接.资产交接" %>
...
<head runat="server">
    ...
    <meta name="sourcefiless" content="School资产交接流程进度.aspx" />
    <title></title>
   <style>
        .photo {
            height: 130px;
