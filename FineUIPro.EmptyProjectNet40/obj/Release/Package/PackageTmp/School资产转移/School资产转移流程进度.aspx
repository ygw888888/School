<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="School资产转移流程进度.aspx.cs" Inherits="FineUIPro.EmptyProjectNet40.School资产转移.School资产转移流程进度" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <ul class="nav nav-pills nav-justified step step-progress" data-step="4">
                <li>
                    <a>申请人提交<span class="caret"></span></a>
                    <br />
                    <asp:Button ID="s" runat="server" Text="查看详情" />
                </li>

                <li>
                    <a>管理员通过<span class="caret"></span></a>
                    <br />
