...
{
    public partial class 折旧分析 : System.Web.UI.Page
    {
        ...
        private void OutputSummaryData1(DataTable source)
        {
            ...
            JObject summary = new JObject();
            summary.Add("名称", "合计");
            //summary.Add("本期折旧", 本期折旧.ToString("F2"));
            summary.Add("累计折旧", 累计折旧.ToString("F2") + "元");
            summary.Add("净值", 净值.ToString("F2") + "元");
            //summary.Add("总账面净值", 总账面净值.ToString("F2"));
        ...
        protected void EndTime_DateSelect(object sender, EventArgs e)
        {
